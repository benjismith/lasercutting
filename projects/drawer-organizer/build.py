...
Options after the `--`:
    ...
    --views LIST     comma-separated subset of iso,top,front (default all)
    --explode IN     lift column dividers by IN inches and row dividers by twice that
...
LABELS = {"wall": "Walls", "column": "Column dividers", "row": "Row dividers"}
...
def build(explode: float = 0.0) -> tuple[design.Design, list[bpy.types.Object]]:
    ...
    lift = {"wall": 0.0, "column": explode, "row": 2 * explode}
